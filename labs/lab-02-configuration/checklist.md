# Lab 02: Project Configuration Baseline — Completion Checklist

---

## Task Completion

- [ ] Task 1 — `.vscode/settings.json` created; `useInstructionFiles` confirmed `true`
- [ ] Task 2 — `.github/copilot-instructions.md` created; Copilot reflects conventions when asked
